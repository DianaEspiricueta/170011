(*         ANALIZADOR LEXICO
170011 Bueno Sánchez Jessica Elizabeth
170010 Rodríguez Espiricueta Diana *)


(*El estado inicial es cuando comienza a leer la primer linea
el estado final es cuando ya no lee lineas, cuando apunta a null*)

open System
open System.Text.RegularExpressions
open System.IO

//se guarda en una pila cuando es correcta la entrada
...
type Data() =       //funcion para realizar lecturas de archivos
    member x.Read() =
        // Read in a file with StreamReader.
        use stream = new StreamReader @"C:\Users\sa\Desktop\Teoria Computacional Final\codigo.txt"//direccion del archivo

        //listas de lo usado en C
